    ...
    <div className="w-full grid lg:grid-cols-2 md:grid-cols-1 items-start">
      <div className="justify-start items-center flex lg:gap-1 lg:text-sm text-xs gap-0 flex-wrap mr-auto">
        <div className={active === 'all' ? `border-b-2 border-purple-600` : ''} onClick={() => setActive('all')}>
          <div className="py-1 rounded-md pb-3 px-2 hover:bg-gray-200 cursor-pointer text-gray-600  ">All</div>
        </div>
        <div
          className={active === 'my_docs' ? `border-b-2 border-purple-600` : ''}
          onClick={() => setActive('my_docs')}
        >
          <div className="py-1 rounded-md pb-3 px-2 hover:bg-gray-200 cursor-pointer text-gray-600 ">My Docs</div>
        </div>
        <div className={active === 'shared' ? `border-b-2 border-purple-600` : ''} onClick={() => setActive('shared')}>
          <div className="py-1 rounded-md pb-3 px-2 hover:bg-gray-200 cursor-pointer text-gray-600 ">Shared</div>
        </div>
        <div
          className={active === 'private' ? `border-b-2 border-purple-600` : ''}
          onClick={() => setActive('private')}
        >
          <div className="py-1 rounded-md pb-3 px-2 hover:bg-gray-200 cursor-pointer text-gray-600 ">Private</div>
        </div>
        <div
          className={active === 'workspace' ? `border-b-2 border-purple-600` : ''}
          onClick={() => setActive('workspace')}
        >
          <div className="py-1 rounded-md pb-3 px-2 hover:bg-gray-200 cursor-pointer text-gray-600 ">Workspace</div>
        </div>
        <div
          className={active === 'assigned' ? `border-b-2 border-purple-600` : ''}
          onClick={() => setActive('assigned')}
        >
          <div className="py-1 rounded-md pb-3 px-2 hover:bg-gray-200 cursor-pointer text-gray-600 ">Assigned</div>
        </div>
        <div
          className={active === 'archived' ? `border-b-2 border-purple-600` : ''}
          onClick={() => setActive('archived')}
        >
          <div className="py-1 rounded-md pb-3 px-2 hover:bg-gray-200 cursor-pointer text-gray-600">Archived</div>
        </div>
      </div>
